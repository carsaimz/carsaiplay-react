...
export default async function handler(req) {
  ...
  await db`INSERT INTO comment_likes (user_id, comment_id, type, created_at) VALUES (${userId}, ${comment_id}, 'dislike', NOW()) ON CONFLICT (user_id, comment_id) DO UPDATE SET type='dislike'`;
