...
export default function App() {
  ...
  const { isConfigured, isLoading: setupLoading, checkSetup } = useSetupStore();
  ...
  // Enquanto verifica setup, mostrar loader simples
  if (setupLoading) return <PageLoader />;

  // Se não está configurado, mostrar wizard
  if (!isConfigured) {
    return (
